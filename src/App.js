...
function App() {
  return (
    <>
    <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded-b dark:bg-gray-900 mb-20">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        <a href="https://www.printecgroup.com/" className="flex items-center">
          <img src="https://www.printecgroup.com/wp-content/uploads/2019/07/printec_logo_white.svg" className="mr-3 h-6 sm:h-12" alt="Printec logo" />
